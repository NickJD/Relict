...
microbiome studies (emphasis on ruminants).  The bundled records are NCBI
RefSeq 16S entries (NR_ prefix), selected as stable reference anchors rather
than as visible biological results.
...
Bacteria
  Bacillota (Firmicutes)           - Ruminococcus, Clostridium, Bacillus,
                                     Lactobacillus, Streptococcus, Butyrivibrio
  Bacteroidota                      - Bacteroides, Prevotella, Porphyromonas
  Pseudomonadota (Proteobacteria)   - Escherichia, Helicobacter, Wolinella
...
NCBI accessions
---------------
These are RefSeq 16S rRNA gene entries (NR_*) for named reference strains.
Most are full-length or near-full-length, and all bundled anchors are currently
>1 000 bp.  Verify at:
